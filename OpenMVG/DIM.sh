...
# Paths
config_file="/dataset/config_DL.yml"
...
MATCHES=$OUTPUT/$(yq e '.dim_matches' "$config_file")
...
openMVG_main_SfM -i $OUTPUT/sfm_data_no_poses.json -m $MATCHES -o $RECONSTRUCTION -s GLOBAL -M $MATCHES/matches.putative.bin
